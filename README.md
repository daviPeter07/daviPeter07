...
Desenvolvedor de Software Full Stack com 2 anos de experiência e founder da [SyncForge](https://syncforge-business.vercel.app/).

Trabalho criando aplicações web completas, do back-end à interface, com foco em organização, performance e manutenção. No dia a dia, uso tecnologias como TypeScript, React, Next.js, Node.js, PHP, Laravel e bancos de dados relacionais para transformar ideias em sistemas reais.
...
Acredito que software não é apenas código. É clareza, processo, manutenção, experiência, performance e impacto. Por isso, procuro sempre desenvolver soluções que facilitem a vida de quem usa e de quem mantém o sistema.
...
- E-mail: **davipetersondev173@gmail.com**
